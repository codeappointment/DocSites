...
//                dialog.setMessage("Choose preference");
    ...
    public int getItemCount() {
     ...
     class VHolder extends RecyclerView.ViewHolder {
        private TextView docName, docText, postTime, delete_post, report, reply, varified;
        ...
        private VHolder(View itemView) {
            super(itemView);
            cardView =  itemView.findViewById(R.id.lollipopcardview);
            ...
            progressBar =  itemView.findViewById(R.id.lollipop_layout_progressbar);
            delete_post =  itemView.findViewById(R.id.delete_post);
            report =  itemView.findViewById(R.id.report);
            reply =  itemView.findViewById(R.id.reply);
            varified =  itemView.findViewById(R.id.lollipopvarified);
            relativeLayout =  itemView.findViewById(R.id.lollipoop);
        }
    }
