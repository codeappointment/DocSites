...
public class Settings extends Activity {
    ...
    private CheckBox residency, notice, dghs, reultBcs, resultDept, resultSenior, regiDept, regiSenior, assistantSurgeon, juniorConsultant,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        residency =  findViewById(R.id.residencySetting);
        notice =  findViewById(R.id.noticeSetting);
        dghs =  findViewById(R.id.DGHSSetting);
        reultBcs =  findViewById(R.id.bcsResultSetting);
        resultDept =  findViewById(R.id.deptResultSetting);
        resultSenior =  findViewById(R.id.seniorResultSetting);
        regiDept =  findViewById(R.id.regiDeptSetting);
        regiSenior =  findViewById(R.id.regiSeniorSetting);
        assistantSurgeon =  findViewById(R.id.assistantSurgeonSetting);
        juniorConsultant =  findViewById(R.id.juniorConsultantSetting);
        seniorConsultant =  findViewById(R.id.seniorConsultantSetting);
        assistantProfessor =  findViewById(R.id.assistantProfessorSetting);
        associateProfessor =  findViewById(R.id.associateProfessorSetting);
        professor =  findViewById(R.id.professorSetting);
        civilSurgeon =  findViewById(R.id.civilSergeonSetting);
        adhoc =  findViewById(R.id.adhocSetting);
        mohfw =  findViewById(R.id.mohfwSetting);
        deputation =  findViewById(R.id.deputationSetting);
        leave =  findViewById(R.id.leaveSetting);
        dgfp =  findViewById(R.id.dgfpSetting);
        ccdBirdem =  findViewById(R.id.ccdSetting);

        TextView select =  findViewById(R.id.select);
        TextView deselect =  findViewById(R.id.deselect);

        TextView heading =  findViewById(R.id.settingHeading);
        int density = getResources().getDisplayMetrics().densityDpi;
        if (density <= DisplayMetrics.DENSITY_HIGH) {
            heading.setTextSize(20);
        }
        preferences = getSharedPreferences("notification", Context.MODE_PRIVATE);
        boolean checked = preferences.getBoolean("residencyChecked", false);
